...
public class Program
{
    ...
    public async Task CosmosAsync()
    {
        ...
        // Run the CreateItemAsync method
        await this.CreateItemAsync();
    }
    ...
    {
        // Create a new Item
        Person saleOrder = new Person 
        {
            Id = "1",
            LastName = "Otis"
        };

        ItemResponse<Person> item = await this.container.CreateItemAsync(saleOrder, new PartitionKey(saleOrder.LastName));
        var test = item.ActivityId;
